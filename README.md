...
- Le repo GitHub est déjà cloné sur ton Mac (tu as déjà un dossier `Apotheoz_Wines` quelque part sur ta machine)

### 1. Ouvrir le projet dans VS Code

- Ouvre VS Code
- `File > Open Folder...` (ou `Cmd + O`)
- Sélectionne le dossier `Apotheoz_Wines` (celui qui contient ce README)
